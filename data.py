...
def random_forest_data():
  ...
  youtube_data_files = ['data/20sec/youtube_01.json', 'data/20sec/youtube_02.json', 'data/20sec/youtube_03.json']
  zoom_data_files = ['data/20sec/zoom_01.json', 'data/20sec/zoom_02.json']
  twitch_data_files = ['data/20sec/twitch_01.json', 'data/20sec/twitch_02.json']
  ...
  min_len = min(len(youtube_data), len(zoom_data), len(twitch_data))
  youtube_data = youtube_data[:min_len+17]
  zoom_data = zoom_data[:min_len+8]
  twitch_data = twitch_data[:min_len]
  ...
  print("youtube_data_num: ", youtube_data_num)
  print("zoom_data_num: ", zoom_data_num)
  print("twitch_data_num: ", twitch_data_num)
  ...
  output_file = 'data/20sec/random_forest_data.json'
  with open(output_file, 'w', encoding="utf-8") as f:
    json.dump(data, f)
